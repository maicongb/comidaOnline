...
status: demonstra o número do problema, por exemplo, 404
type: identifica o tipo do problema
title: descrição do problema
detail: mostra uma descrição mais especifica do problema

*/

//SÓ MOSTRARÁ AS ENTIDADES QUE NÃO FOREM NULL
